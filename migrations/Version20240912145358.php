 ...
 */
final class Version20240912145358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tipo_referencia (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE norma DROP norma_origen_id, DROP norma_destino_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE tipo_referencia');
        $this->addSql('ALTER TABLE norma ADD norma_origen_id INT DEFAULT NULL, ADD norma_destino_id INT DEFAULT NULL');
