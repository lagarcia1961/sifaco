 ...
 */
final class Version20240806143526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE norma_tema (norma_id INT NOT NULL, tema_id INT NOT NULL, INDEX IDX_922657C9E06FC29E (norma_id), INDEX IDX_922657C9A64A8A17 (tema_id), PRIMARY KEY(norma_id, tema_id)) DEFAULT CHARACTER SET utf8mb4');
